<div class="modal fade" id="modaladddepartment">
    <div class="modal-dialog">
        <div class="modal-content">
        	<form method="post" action="{{ route('inventory.route',['path' => $path, 'action' => 'create-department', 'id' => encrypt(1)]) }}"> @csrf
        		...
        		<div class="modal-body">
					<div class="form-group">
				      	...
				      	<input type="text" class="form-control" name="option[0][code]" autocomplete="department-code" maxlength="50"  value="{{ strtoupper(uniqid()) }}" required>
				    </div>
			    	<div class="form-group">
			          	<label>Description</label> <span class="text-red">*</span>
			          	<input type="text" class="form-control" name="option[0][description]" autocomplete="department-description" maxlength="100" required>
			        </div>
			        <hr>
