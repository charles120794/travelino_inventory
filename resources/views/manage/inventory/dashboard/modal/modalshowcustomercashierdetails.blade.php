<div class="modal fade" id="modalshowcustomercashierdetails">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
        	<div class="modal-header">
    		    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    		    <span aria-hidden="true"> &times; </span></button>
    		    <h4 class="modal-title"><i class="fa fa-users"></i> Purchased Products </h4>
    		</div>
    		<div class="modal-body" style="min-height: 65vh;">
                <div id="customercashierdetails" style="display: none;"><div id="loader"></div></div>
    		</div>
