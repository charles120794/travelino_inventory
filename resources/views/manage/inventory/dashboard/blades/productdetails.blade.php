...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control bg-white" style="resize: vertical; height: 160px;" disabled>{{ $product->item_long_description }}</textarea>
        </div>
    </div>
    <div class="col-md-4">
        <img src="{{ Storage::url($product->item_image) }}" class="img-responsive" style="max-height: 260px;">
    </div>
</div>
<div class="row">
    <div class="col-md-6">
