                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"> Issuance Return No. </label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"> Return To </label>
                                                <input type="text" class="form-control" name="issue_code">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="box box-primary">
                                 <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"> Issue Cost </label>
                                        <input type="text" class="form-control" name="issue_code">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"> Return Cost </label>
                                        <input type="text" class="form-control" name="issue_code">
                                    </div>
                                </div>
                            </div>
