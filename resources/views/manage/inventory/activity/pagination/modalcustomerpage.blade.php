<div class="box box-default box-solid">
    <div class="box-body">
        ...
        <div class="row" style="overflow-x: auto;">
            <div class="col-md-12">
            	<table class="table table-bordered table-condensed table-hover" style="max-height: 70vh; overflow-y: scroll;">
            	    <thead>
            	    ...
            	    <tbody>
            	        ...
            	        <tr>
            	            ...
            	            <td class="v-align-middle">{{ $customer->customerContact['contact_number'] }}</td>
            	            <td class="v-align-middle">{{ $customer->customerContact['contact_email'] }}</td>
