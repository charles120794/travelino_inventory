<form method="post" action="{{ route('actions.route', ['path' => $path, 'action' => 'search-users-module-table', 'id' => encrypt($thisUserAccount->users_id)]) }}" id="form_search_users_module" data-request="json"> 
	{{ csrf_field() }}
