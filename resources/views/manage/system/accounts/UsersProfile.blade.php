		...
		<div class="col-md-9">
			...
			<div class="nav-tabs-custom">
				...
				<div class="pull-right" style="margin-right: 20px; margin-top: -60px;">
					<p>Account Status &nbsp;&nbsp;
						<i class="{{ ($thisUserAccount->status == 1) ? 'fa fa-toggle-on text-orange' : 'fa fa-toggle-off text-red' }}" id="togglestatus{{ $thisUserAccount->users_id }}" onclick="return updateStatus(this.id,'{{ route('common.route',['path' => 'common-method-function', 'action' => 'toggle-users-profile', 'id' => encrypt($thisUserAccount->users_id)]) }}')" style="font-size: 23px; cursor: pointer;"></i> 
					</p>
				</div>
