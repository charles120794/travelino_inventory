                ...
                <div class="panel-body">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="@if(request()->get('tab') == 'all-account') active @endif @if(!request()->has('tab')) active @endif"><a href="#list" data-toggle="tab"><b> <i class="fa fa-list"></i> ALL USER ACCOUNT </b></a></li>
                            <li class="@if(request()->get('tab') == 'add-account') active @endif"><a href="#add" data-toggle="tab"><b> <i class="fa fa-plus"></i> ADD USER ACCOUNT </b></a></li>
                        </ul>
                    </div>
