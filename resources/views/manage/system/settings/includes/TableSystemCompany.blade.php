<div class="row">
	<div class="col-lg-12" style="overflow: auto;">
		<table class="table table-bordered table-condensed company-datatables" id="users_table">
			<thead>
				<tr style="font-size: 12px; white-space: nowrap;">
					<th class="text-center" style="vertical-align: top; width: 10%;"> ID </th>
					<th class="text-center" style="vertical-align: top; width: 10%;"> CODE </th>
					<th class="text-center" style="vertical-align: top; width: 20%;"> NAME </th>
					{{-- <th class="text-center" style="vertical-align: top; min-width: 150px;"> DESCRIPTION </th> --}}
					<th class="text-center" style="vertical-align: top; width: 40%;"> TAGLINE </th>
