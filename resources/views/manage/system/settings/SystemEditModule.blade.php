                ...
                <div class="panel-body">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li><a href="#list" data-toggle="tab"><b> <i class="fa fa-list"></i> ALL MODULE </b></a></li>
                            <li><a href="#add" data-toggle="tab"><b> <i class="fa fa-plus"></i> ADD MODULE </b></a></li>
                            <li class="active"><a href="#edit" data-toggle="tab"><b> <i class="fa fa-edit"></i> EDIT MODULE </b></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active fade in" id="edit">
                            @include('manage.system.settings.forms.FormEditModule')
                        </div>
                    </div>
