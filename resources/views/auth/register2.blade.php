                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="firstname" class="col-md-4 col-form-label text-md-right"><span style="color: red">*</span> {{ __('Firstname') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="lastname" class="col-md-4 col-form-label text-md-right"><span style="color: red">*</span> {{ __('Lastname') }}</label>
